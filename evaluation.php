...
<form name="form1" method="post" action="">
 ...
 <p>
  ...
  <p>	  
    <input type="text" name="textfield2" value="securite"><br> <br>
    Conduite :
    <input type="text" name="textfield3" value="conduite"> <br><br>
    Confort : 
    <input type="text" name="textfield4" value="confort"><br><br>
  </p>
...
<?php
    ...
    ?>
<footer>Copyright 2023 © CER Réseau. - Mentions légales <br>KHECHINI HOUSSEM EDDINE G1<br>AKERMI FARAH G2</footer>
</body>
